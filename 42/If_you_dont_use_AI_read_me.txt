WaterkoofAI x 42 Airdrop Script Kit

HOW TO SET UP WITHOUT AI
========================

This Kit guides 42 activity using Bitget Wallet to help you build speculative eligibility through trading, referrals, campaign tickets, and community engagement.
...
Important: 42 is an event/prediction market that may involve real USDT on BNB Chain. Do not use it unless it is legal for your location and you accept the risk.
...
- Keep "network" as "bsc"
- Keep "payment_token" as "USDT"
- Set "default_trade_amount_usdt" to the amount you may choose manually
- Set "i_confirm_42_is_legal_for_me" to true only after checking local rules
- Set "enable_real_money_tasks" to true only if you want guided USDT funding/trading prompts
- Save the file
