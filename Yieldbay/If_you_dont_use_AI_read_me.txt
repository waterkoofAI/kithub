WaterkoofAI x Yieldbay Airdrop Script Kit

HOW TO SET UP WITHOUT AI
========================

This Kit guides Yieldbay activity using Bitget Wallet to help you earn Yieldbay Points through wallet connection, social tasks, Genesis Yieldo NFT mint, referrals, dashboard, Copilot, DeFi actions, and partner campaigns.
