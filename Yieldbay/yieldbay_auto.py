"""
WaterkoofAI x Yieldbay Airdrop Script Kit v1.0
======================================================
COVERAGE DECLARATION:
- Project: Yieldbay
- Portal URL: https://app.yieldbay.fi/
...
- Estimated points from this Kit: Yieldbay Points from product, social, referral, and campaign activity may matter if a future token is launched. No airdrop is confirmed.
...
# -- Yieldbay URLs --
PROJECT_HOME = "https://yieldbay.fi/"
PROJECT_APP = "https://app.yieldbay.fi/"
AIRDROP_GUIDE_URL = "https://airdrops.io/yieldbay/"
...
NETWORK_NAME = "Solana"
LEGAL_FLAG = "i_understand_yieldbay_defi_risks"
LEGAL_TEXT = "Yieldbay can route real Solana DeFi deposits, staking, lending, and LP positions. Confirm smart contract and market risk before enabling capital prompts."

TASKS_JSON = r'''[
  {
    "description": "Connect wallet",
    "url": "https://app.yieldbay.fi/",
    "selectors": [
      "text=Connect Wallet",
      "text=Connect",
    ...
    "prompt": "Connect Bitget Wallet on Solana and review the connection popup."
  },
  {
    "description": "Complete profile tasks",
    "url": "https://app.yieldbay.fi/",
    "selectors": [
      "text=Account",
      "text=Profile",
    ...
    "requires_real_money": false,
    "prompt": "Open Account/Profile and complete social/community Genesis tasks manually."
  },
  {
    "description": "Mint Genesis Yieldo NFT",
    "url": "https://app.yieldbay.fi/",
    "selectors": [
      "text=Mint",
      "text=Genesis",
    ...
    "requires_real_money": false,
    "prompt": "Mint the free Genesis Yieldo NFT manually if available and review any wallet popup."
  },
  {
    "description": "Claim referral link",
    "url": "https://app.yieldbay.fi/",
    "selectors": [
      "text=Referral",
      "text=Invite",
    ...
    "requires_real_money": false,
    "prompt": "Copy your referral link after completing profile tasks."
  },
  {
    "description": "Explore dashboard and Copilot",
    "url": "https://app.yieldbay.fi/",
    "selectors": [
      "text=Dashboard",
      "text=Copilot",
    ...
    "requires_real_money": false,
    "prompt": "Review Solana yield positions and Copilot suggestions manually."
  },
  {
    "description": "Deposit, stake, or LP",
    "url": "https://app.yieldbay.fi/",
    "selectors": [
      "text=Deposit",
      "text=Stake",
    ...
    "prompt": "Use Kamino, Jupiter Lend, Jito, or Meteora flows only if you accept DeFi risk."
  },
  {
    "description": "Claim fees or rewards",
    "url": "https://app.yieldbay.fi/",
    "selectors": [
      "text=Rewards",
      "text=Claim",
    ...
    "requires_real_money": false,
    "prompt": "Check Rewards and claim only after reviewing wallet prompts."
  },
  {
    "description": "Join partner campaigns",
    "url": "https://app.yieldbay.fi/",
    "selectors": [
      "text=Campaign",
      "text=Partner",
    ...
    "requires_real_money": false,
    "prompt": "Check active partner campaigns and complete only tasks you understand."
  }
]'''
...
def connect_bitget_wallet(page):
    ...
    if not clicked:
        wait_for_user(
            f"Click the wallet, connect, sign in, or account button in the Yieldbay browser tab.\n\n"
    ...
    if extension_detected:
        ...
        wait_for_user(
            ...
            f"  1. Confirm the site is the official Yieldbay site.\n"
...
def run_wallet(wallet, config, context):
    ...
    step("Opening Yieldbay...")
    page.goto(PROJECT_APP)
    page.wait_for_load_state("domcontentloaded", timeout=30000)
    time.sleep(3)
    success("Yieldbay loaded")
...
Yieldbay Activity Checklist:
  [x] Connect wallet
  [x] Complete profile tasks
  [x] Mint Genesis Yieldo NFT
  [x] Claim referral link
  [x] Explore dashboard and Copilot
  [x] Deposit, stake, or LP
  [x] Claim fees or rewards
  [x] Join partner campaigns
