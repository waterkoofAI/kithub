"""
WaterkoofAI x OmenX Airdrop Script Kit v1.0
======================================================
COVERAGE DECLARATION:
- Project: OmenX
- Portal URL: https://www.omenx.com/
...
- Estimated points from this Kit: OmenX Points may accrue from trading, campaigns, event participation, referrals, and platform activity. No token distribution is guaranteed.
...
# -- OmenX URLs --
PROJECT_HOME = "https://www.omenx.com/"
PROJECT_APP = "https://www.omenx.com/"
AIRDROP_GUIDE_URL = "https://airdrops.io/omenx/"
...
LEGAL_FLAG = "i_confirm_omenx_is_legal_for_me"
LEGAL_TEXT = "OmenX is a leveraged prediction-market platform. Confirm this activity is legal for you and that you understand leverage and market risk before enabling capital prompts."

TASKS_JSON = r'''[
  {
    "description": "Set up OmenX account",
    "url": "https://www.omenx.com/",
    "selectors": [
      "text=Sign In",
    ...
    "prompt": "Sign in or create your account manually. Use Bitget Wallet if a wallet connection is offered."
  },
  {
    "description": "Fund account",
    "url": "https://www.omenx.com/portfolio",
    "selectors": [
      "text=Deposit",
      "text=Fund",
      "text=Wallet"
    ...
    "prompt": "Fund your account manually only if legal and desired. Use Base USDC/ETH carefully and review every wallet popup."
  },
  {
    ...
    "requires_real_money": false,
    "prompt": "Choose an event market you understand. Avoid markets whose rules are unclear."
  },
  {
    "description": "Open long or short position",
    "url": "https://www.omenx.com/",
    "selectors": [
      "text=Long",
      "text=Short",
    ...
    "requires_real_money": true,
    "prompt": "Choose direction, size, and leverage manually. Confirm only if you accept the risk."
  },
  {
    "description": "Check Rewards Center",
    "url": "https://www.omenx.com/",
    "selectors": [
      "text=Rewards",
      "text=Reward Center",
    ...
    "requires_real_money": false,
    "prompt": "Open the Reward Center and complete available tasks manually."
  },
  {
    ...
    "requires_real_money": false,
    "prompt": "Copy your OmenX referral link manually if available."
  },
  {
    "description": "Review leaderboard and portfolio",
    "url": "https://www.omenx.com/leaderboard",
    "selectors": [
      "text=Leaderboard",
      "text=Portfolio",
      "text=Points"
    ...
    "requires_real_money": false,
    "prompt": "Check your points, position, and open trades before finishing."
  }
]'''
...
def connect_bitget_wallet(page):
    ...
    if not clicked:
        wait_for_user(
            f"Click the wallet, connect, sign in, or account button in the OmenX browser tab.\n\n"
    ...
    time.sleep(2)
    click_if_visible(page, "button:has-text('Select Wallet to Login')", timeout=3000)
    extension_selectors = [
    ...
    if extension_detected:
        ...
        wait_for_user(
            ...
            f"  1. Confirm the site is the official OmenX site.\n"
...
OmenX Activity Checklist:
  [x] Set up OmenX account
  [x] Fund account
  [x] Select a market
  [x] Open long or short position
  [x] Check Rewards Center
  [x] Copy referral link
  [x] Review leaderboard and portfolio
