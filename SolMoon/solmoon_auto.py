"""
WaterkoofAI x SolMoon Airdrop Script Kit v1.0
======================================================
COVERAGE DECLARATION:
- Project: SolMoon
- Portal URL: https://solmoon.gg/
...
- Estimated points from this Kit: Fragments from gameplay and streaks may determine future allocation. The airdrop is marked confirmed but conversion details are not announced.
...
# -- SolMoon URLs --
PROJECT_HOME = "https://solmoon.gg/"
PROJECT_APP = "https://solmoon.gg/"
AIRDROP_GUIDE_URL = "https://airdrops.io/solmoon/"
...
NETWORK_NAME = "Solana"
LEGAL_FLAG = "i_confirm_solmoon_is_legal_for_me"
LEGAL_TEXT = "SolMoon uses real SOL staking and game positions. Confirm local legality and risk before enabling play prompts."

TASKS_JSON = r'''[
  {
    "description": "Connect wallet",
    "url": "https://solmoon.gg/",
    "selectors": [
      "text=Connect",
      "button:has-text('Connect')"
    ],
    "requires_real_money": false,
    "prompt": "Connect Bitget Wallet on Solana and review the popup."
  },
  {
    "description": "Deposit SOL to balance",
    "url": "https://solmoon.gg/",
    "selectors": [
      "text=Deposit",
      "text=Balance",
    ...
    "prompt": "Deposit SOL manually only if legal and desired. Minimum deposit may be around 0.001 SOL."
  },
  {
    "description": "Play Rug Scan",
    "url": "https://solmoon.gg/",
    "selectors": [
      "text=Rug Scan",
      "text=Stake",
    ...
    "requires_real_money": true,
    "prompt": "Choose a token tier, set stake manually, reveal tiles, and cash out cautiously."
  },
  {
    "description": "Build streaks and fragments",
    "url": "https://solmoon.gg/",
    "selectors": [
      "text=Tap Trade",
      "text=Fragments",
    ...
    "requires_real_money": true,
    "prompt": "Play short sessions manually to build fragments and streaks without exceeding your budget."
  },
  {
    "description": "Join hourly airdrop",
    "url": "https://solmoon.gg/",
    "selectors": [
      "text=Airdrop",
      "text=Stake"
    ...
    "requires_real_money": true,
    "prompt": "Check the hourly airdrop requirement and participate only if you accept SOL risk."
  },
  {
    "description": "Copy affiliate/referral link",
    "url": "https://solmoon.gg/",
    "selectors": [
      "text=Affiliate",
      "text=Referral",
    ...
    "requires_real_money": false,
    "prompt": "Open Affiliate or Leaderboard and save your referral code if available."
  }
]'''
...
def connect_bitget_wallet(page):
    ...
    click_if_visible(page, "button:has-text('Got it')", timeout=3000)
    ...
    if not clicked:
        wait_for_user(
            f"Click the wallet, connect, sign in, or account button in the SolMoon browser tab.\n\n"
    ...
    if extension_detected:
        ...
        wait_for_user(
            ...
            f"  1. Confirm the site is the official SolMoon site.\n"
...
def run_wallet(wallet, config, context):
    ...
    step("Opening SolMoon...")
    page.goto(PROJECT_APP)
    page.wait_for_load_state("domcontentloaded", timeout=30000)
    time.sleep(3)
    success("SolMoon loaded")
...
SolMoon Activity Checklist:
  [x] Connect wallet
  [x] Deposit SOL to balance
  [x] Play Rug Scan
  [x] Build streaks and fragments
  [x] Join hourly airdrop
  [x] Copy affiliate/referral link
