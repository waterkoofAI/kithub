"""
WaterkoofAI x Picks Airdrop Script Kit v1.0
======================================================
COVERAGE DECLARATION:
- Project: Picks
- Portal URL: https://getpicks.app/
...
- Estimated points from this Kit: Early real-money activity and referrals could matter if Picks later rewards early users, but no airdrop is confirmed.
...
# -- Picks URLs --
PROJECT_HOME = "https://getpicks.app/"
PROJECT_APP = "https://go.getpicks.app/"
AIRDROP_GUIDE_URL = "https://airdrops.io/picks/"
...
NETWORK_NAME = "EVM or Solana"
LEGAL_FLAG = "i_confirm_picks_is_legal_for_me"
LEGAL_TEXT = "Picks is a real-money sports prediction skill game. Confirm local legality and risk before enabling play prompts."

TASKS_JSON = r'''[
  {
    "description": "Open Picks and connect wallet",
    "url": "https://getpicks.app/",
    "selectors": [
      "text=Connect",
      "text=Wallet",
      "text=Sign up"
    ...
    "prompt": "Connect Bitget Wallet if supported and complete signup manually."
  },
  {
    ...
    "requires_real_money": false,
    "prompt": "Claim any welcome or starter bonus manually after reading its terms."
  },
  {
    ...
    "prompt": "Deposit only funds you are willing to risk and only where legal."
  },
  {
    "description": "Choose sport and players",
    "url": "https://getpicks.app/",
    "selectors": [
      "text=Football",
      "text=Basketball",
    ...
    "requires_real_money": false,
    "prompt": "Pick a sport and review player cards, stat lines, and settlement rules."
  },
  {
    "description": "Build and submit lineup",
    "url": "https://getpicks.app/",
    "selectors": [
      "text=More",
      "text=Less",
    ...
    "requires_real_money": true,
    "prompt": "Build a 2 to 6 pick lineup manually and submit only if you accept the risk."
  },
  {
    ...
    "requires_real_money": false,
    "prompt": "Copy your referral link manually if available."
  }
]'''
...
def connect_bitget_wallet(page):
    ...
    clicked = click_if_visible(page, "button:has-text('Sign In')", timeout=2000)
    time.sleep(1)
    ...
    if not clicked:
        wait_for_user(
            f"Click the wallet, connect, sign in, or account button in the Picks browser tab.\n\n"
    ...
    time.sleep(2)
    search_input = page.get_by_placeholder("Search through", exact=False)
    search_input.click()
    search_input.press_sequentially("Bitget Wallet", delay=100)
    ...
    if extension_detected:
        ...
        wait_for_user(
            "Select EVM or Solana.\n"
            "Bitget Wallet should now show a connection popup.\n\n"
            f"  1. Confirm the site is the official Picks site.\n"
...
Picks Activity Checklist:
  [x] Open Picks and connect wallet
  [x] Claim welcome bonus
  [x] Deposit crypto
  [x] Choose sport and players
  [x] Build and submit lineup
