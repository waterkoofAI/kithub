WaterkoofAI x Uponly Airdrop Script Kit

HOW TO SET UP WITHOUT AI
========================

This Kit helps guide Uponly testnet activity using Bitget Wallet to help you build potential UPR competition eligibility through test trading, quests, and referrals.
...
- Replace "0xYourBitgetWalletAddress" with your Bitget Wallet address or local display address
- Keep "network" as "solana"
- Set "preferred_trade_size_usdc" to the test USDC amount you want to use manually
- Save the file
