"""
WaterkoofAI x STRATO Airdrop Script Kit v1.0
======================================================
COVERAGE DECLARATION:
- Project: STRATO
- Portal URL: https://app.strato.nexus/dashboard/
...
- Estimated points from this Kit: Season 2 points accrue from active capital deployment and may map to the native token at TGE, but conversion details are not guaranteed.
...
# -- STRATO URLs --
PROJECT_HOME = "https://strato.nexus/"
PROJECT_APP = "https://app.strato.nexus/dashboard/"
AIRDROP_GUIDE_URL = "https://airdrops.io/strato/"
...
NETWORK_NAME = "STRATO / EVM"
LEGAL_FLAG = "i_understand_strato_defi_risks"
LEGAL_TEXT = "STRATO uses real DeFi deposits, minting, staking, LP, and bridging. Confirm you understand smart contract, bridge, liquidation, and market risks before enabling capital prompts."

TASKS_JSON = r'''[
  {
    "description": "Open rewards dashboard",
    "url": "https://app.strato.nexus/dashboard/",
    "selectors": [
      "text=Rewards",
      "text=Dashboard",
      "text=Points"
    ...
    "prompt": "Review the Rewards dashboard and the available Season 2 activities."
  },
  {
    "description": "Choose earning activity",
    "url": "https://app.strato.nexus/dashboard/",
    "selectors": [
      "text=APY",
      "text=Earn",
    ...
    "requires_real_money": false,
    "prompt": "Compare estimated APY, emissions, and TVL before selecting one activity."
  },
  {
    "description": "Deposit, mint, stake, or LP",
    "url": "https://app.strato.nexus/dashboard/",
    "selectors": [
    ...
    "prompt": "Deploy capital manually only if you accept the risk. Review collateral, debt, fees, and every Bitget Wallet popup."
  },
  {
    "description": "Bridge or direct mint USDST",
    "url": "https://app.strato.nexus/dashboard/",
    "selectors": [
      "text=Bridge",
      "text=Mint",
    ...
    "requires_real_money": true,
    "prompt": "Bridge or mint manually only after checking bridge route, token, network, and fees."
  },
  {
    "description": "Track and claim points",
    "url": "https://app.strato.nexus/dashboard/",
    "selectors": [
    ...
    "requires_real_money": false,
    "prompt": "Check points and claim only after reviewing any wallet request."
  },
  {
    ...
    "requires_real_money": false,
    "prompt": "Find and copy your STRATO referral link manually if available."
  }
]'''
...
def connect_bitget_wallet(page):
    ...
    if not clicked:
        wait_for_user(
            f"Click the wallet, connect, sign in, or account button in the STRATO browser tab.\n\n"
    ...
    if extension_detected:
        ...
        wait_for_user(
            ...
            f"  1. Confirm the site is the official STRATO site.\n"
...
STRATO Activity Checklist:
  [x] Open rewards dashboard
  [x] Choose earning activity
  [x] Deposit, mint, stake, or LP
  [x] Bridge or direct mint USDST
  [x] Track and claim points
