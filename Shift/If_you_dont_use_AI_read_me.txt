WaterkoofAI x SHIFT Airdrop Script Kit

HOW TO SET UP WITHOUT AI
========================

This Kit automates SHIFT activity using Bitget Wallet to help you start the pre-registration flow and prepare for loyalty badge tasks.
...
- Replace "YOUR_REFERRAL_CODE" with your SHIFT referral code if you have one
- Save the file
...
Navigate to this folder using 'cd':
  cd c:\dev\kithub\kits\shift\project-kit
Then run:
