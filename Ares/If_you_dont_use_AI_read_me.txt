WaterkoofAI x Ares Airdrop Script Kit

HOW TO SET UP WITHOUT AI
========================

This Kit guides Ares activity using Bitget Wallet to help you join the Ares early-access flow, collect referral position, explore the terminal, install the tracker extension, and optionally prepare copy-trading activity.
