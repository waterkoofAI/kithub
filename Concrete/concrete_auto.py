"""
WaterkoofAI x Concrete Airdrop Script Kit v1.0
======================================================
COVERAGE DECLARATION:
- Project: Concrete
- Portal URL: https://app.concrete.xyz/earn
- Total airdrop tasks: 10
- Tasks automated by this Kit: 10 / 10 guided steps (100%)
...
- Estimated points from this Kit: Concrete Points and Bags may convert to future incentives, but no token or airdrop is officially confirmed.
...
# -- Concrete URLs --
PROJECT_HOME = "https://concrete.xyz/"
PROJECT_APP = "https://app.concrete.xyz/earn"
AIRDROP_GUIDE_URL = "https://airdrops.io/concrete/"
...
NETWORK_NAME = "Ethereum / Arbitrum / Berachain"
LEGAL_FLAG = "i_understand_concrete_defi_risks"
LEGAL_TEXT = "Concrete uses real vault deposits across multiple chains. Confirm jurisdiction eligibility, smart contract, bridge, and market risk before enabling capital prompts."

TASKS_JSON = r'''[
  {
    "description": "Open Points dashboard",
    "url": "https://points.concrete.xyz/",
    "selectors": [
      "text=Connect",
      "text=Points",
      "text=Leaderboard"
    ...
    "prompt": "Open the Points dashboard and log in with Bitget Wallet if supported."
  },
  {
    ...
    "requires_real_money": false,
    "prompt": "Enter referral code 6a71f1e1 manually if the leaderboard asks for a code."
  },
  {
    ...
    "requires_real_money": false,
    "prompt": "Link only accounts you are comfortable connecting. The script does not submit credentials."
  },
  {
    "description": "Complete social quests",
    "url": "https://points.concrete.xyz/",
    "selectors": [
      "text=Quests",
      "text=X",
    ...
    "requires_real_money": false,
    "prompt": "Complete X follow/social quests and verify them manually."
  },
  {
    ...
    "requires_real_money": false,
    "prompt": "Open Profile and complete the daily check-in if available."
  },
  {
    "description": "Join Discord roles",
    "url": "https://airdrops.io/concrete/",
    "selectors": [
      "text=Discord",
      "text=Newbie",
      "text=Vault Navigator"
    ],
    "requires_real_money": false,
    "prompt": "Join the official Discord and work on role milestones manually."
  },
  {
    "description": "Deposit into vaults",
    ...
    "prompt": "Deposit into Concrete vaults only if eligible and comfortable with DeFi risk."
  },
  {
    ...
    "requires_real_money": false,
    "prompt": "Copy your Concrete referral link manually."
  },
  {
    "description": "Article of the Week",
    "url": "https://points.concrete.xyz/",
    "selectors": [
      "text=Article",
      "text=Submit",
    ...
    "requires_real_money": false,
    "prompt": "Check the weekly article topic and submit manually only if you want to participate."
  },
  {
    "description": "Optional campaign boost",
    "url": "https://app.concrete.xyz/earn",
    "selectors": [
      "text=Binance",
      "text=Campaign",
    ...
    "requires_real_money": true,
    "prompt": "Review optional campaign requirements manually. This kit uses Bitget Wallet only; do not switch wallets inside this script."
  }
]'''
...
def connect_bitget_wallet(page):
    ...
    if not clicked:
        click_if_visible(page, "button:has-text('I Agree')", timeout=3000)
        wait_for_user(
            f"Click the wallet, connect, sign in, or account button in the Concrete browser tab.\n\n"
    ...
    if extension_detected:
        ...
        wait_for_user(
            ...
            f"  1. Confirm the site is the official Concrete site.\n"
...
def run_wallet(wallet, config, context):
    ...
    step("Opening Concrete...")
    page.goto(PROJECT_APP)
    page.wait_for_load_state("domcontentloaded", timeout=30000)
    time.sleep(3)
    success("Concrete loaded")
...
Concrete Activity Checklist:
  [x] Open Points dashboard
  [x] Enter referral code
  [x] Link accounts
  [x] Complete social quests
  [x] Daily check-in
  [x] Join Discord roles
  [x] Deposit into vaults
  [x] Copy referral link
  [x] Article of the Week
  [x] Optional campaign boost
