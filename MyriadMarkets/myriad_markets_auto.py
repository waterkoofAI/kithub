"""
WaterkoofAI x Myriad Markets Airdrop Script Kit v1.0
======================================================
COVERAGE DECLARATION:
- Project: Myriad Markets
- Portal URL: https://myriad.markets/markets
...
- Estimated points from this Kit: MYR Points accrue from trading volume, predictions, quests, referrals, and contests. A token allocation is not confirmed.
...
6. Run: python myriad_markets_auto.py
...
# -- Myriad Markets URLs --
PROJECT_HOME = "https://myriad.markets/"
PROJECT_APP = "https://myriad.markets/markets"
AIRDROP_GUIDE_URL = "https://airdrops.io/myriad-markets/"
...
NETWORK_NAME = "Abstract / BNB Chain"
LEGAL_FLAG = "i_confirm_myriad_is_legal_for_me"
LEGAL_TEXT = "Myriad Markets is a prediction-market platform. Confirm local legality and trading risk before enabling capital prompts."

TASKS_JSON = r'''[
  {
    "description": "Connect wallet on Myriad",
    ...
    "prompt": "Connect Bitget Wallet and add Abstract network if prompted."
  },
  {
    "description": "Add BNB address in profile",
    "url": "https://myriad.markets/markets",
    "selectors": [
      "text=Profile",
      "text=Settings",
    ...
    "requires_real_money": false,
    "prompt": "Open Profile Settings and add your BNB Chain address manually if supported."
  },
  {
    ...
    "prompt": "Deposit USDC on Abstract or USD1 on BNB only if legal and desired."
  },
  {
    "description": "Trade live markets",
    "url": "https://myriad.markets/markets",
    "selectors": [
      "text=Markets",
      "text=Trade Now",
    ...
    "requires_real_money": true,
    "prompt": "Pick markets you understand, choose Yes/No manually, and review each wallet popup."
  },
  {
    "description": "Complete Earn quests",
    "url": "https://myriad.markets/markets",
    "selectors": [
      "text=Earn",
      "text=Quests",
    ...
    "requires_real_money": false,
    "prompt": "Open the Earn page and complete available quests manually."
  },
  {
    "description": "Join World Cup contest and referrals",
    "url": "https://myriad.markets/world-cup",
    "selectors": [
      "text=World Cup",
      "text=Leaderboard",
      "text=Referral",
    ...
    "requires_real_money": false,
    "prompt": "Check contest leaderboard and copy your referral link if available."
  }
]'''
...
def connect_bitget_wallet(page):
    ...
    if not clicked:
        wait_for_user(
            f"Click the wallet, connect, sign in, or account button in the Myriad Markets browser tab.\n\n"
    ...
    if extension_detected:
        ...
        wait_for_user(
            ...
            f"  1. Confirm the site is the official Myriad Markets site.\n"
...
def run_wallet(wallet, config, context):
    ...
    step("Opening Myriad Markets...")
    page.goto(PROJECT_APP)
    page.wait_for_load_state("domcontentloaded", timeout=30000)
    time.sleep(3)
    success("Myriad Markets loaded")
...
Myriad Markets Activity Checklist:
  [x] Connect wallet on Myriad
  [x] Add BNB address in profile
  [x] Fund wallet
  [x] Trade live markets
  [x] Complete Earn quests
  [x] Join World Cup contest and referrals
